...
async def digest_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
	...
	if chat.type != "private":
		...
		try:
			...
			await update.message.reply_text(get_text('digest_sent_success', lang))
		except Exception:
			await update.message.reply_text(get_text('digest_start_needed', lang))
		return
	...
	if not found_any:
		await update.message.reply_text(get_text('digest_no_admin_groups', lang))
